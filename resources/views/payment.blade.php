...
<div class="row">
    ...
    <div class="col-lg-12">
   <center>
    <form action="{{ url('paymentcheck') }}" method="POST">
   @csrf
...
<input type="hidden" name="billing_address" value="{{  $paydata['cid'] }}" readonly/>                    
<input type="hidden" name="billing_email" value="{{  $paydata['email'] }}"/>
<input type="hidden" name="amount" value="{{  $paydata['amount'] }}"/> 
<input type="hidden" name="merchant_param1" value="{{  $paydata['shopping_order_id'] }}"/>
<input type="hidden" name="currency" value="INR"/>
<input type="hidden" name="merchant_id" value="1898259"/>              
<input type="hidden" name="redirect_url" value="https://pinkeonline.com/verify"/>
<input type="hidden" name="cancel_url" value="https://pinkeonline.com/verify"/>
<input type="hidden" name="language" value="EN" />
<input type="hidden" name="order_id" value="{{  $paydata['shopping_order_id'] }}" readonly/>      
<input type="hidden" name="billing_tel" value="{{  $paydata['mobile'] }}"/> 
<input type="hidden" name="billing_name" value="{{  $paydata['name'] }}"/> 
