                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="breadcumb">
                            ...
                            <li class="rabeya-breadcumb"><a class="rabeya-breadcumb-link current" href="#">Login</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-10">
                            <div class="form-box">
                                ...
                                <form class="form"action="{{ route('userlog') }}" method="post">
                                @csrf
                                ...
                                <a class="create-account-link" href="{{ route('useregister') }}">New Here? Create an account</a>
                            </div>
                        </div>
                    </div>   
                </div>   
